...
// Do not edit the code below.
  ...
  */
  ...
  //Code Here
  let postTaxPrices = prices.map((e) => e+=e*.07);
...
let x = monsterInYourPocket.filter((obj) => obj['CP']>200)
...
let ordersTotal = orders.reduce((acc, val) => acc + Object.values(val).reduce((n, v) => n + v))
...
const bobsTotal = purchases.reduce((acc, val) => val['owner'] === 'Bob'?acc+val['total']:null)
